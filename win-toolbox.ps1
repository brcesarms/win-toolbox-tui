...
function Invoke-ModoPMA {
    ...
    Install-WingetApp "TheDocumentFoundation.LibreOffice" "LibreOffice" "libreoffice"
...
function Execute-SingleOption {
    ...
    switch ($op) {
        ...
        "10"  { Install-WingetApp "TheDocumentFoundation.LibreOffice" "LibreOffice" "libreoffice" }
        "2C"  { Install-WingetApp "TheDocumentFoundation.LibreOffice" "LibreOffice" "libreoffice" }
